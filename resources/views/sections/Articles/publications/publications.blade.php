                    ...
                    <tbody>
                        @foreach($publications as $key => $publication)
                            <tr>
                                ...
                                <td> {{ date_format(date_create(Date($publication['ispublished'])), 'd M, Y') }}</td>
                                <td>
                                    <a href="{{asset('/storage/'.$publication['downloads'])}}" class="btn w-50 bg-green-800 hover:bg-green-900 hover:text-green-100 text-gray-100">
