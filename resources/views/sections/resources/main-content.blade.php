                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="row d-flex">
                                        <div class="col d-flex align-items-center justify-content-center fw-bold fs-5">{{ $resource->name }}</div>
                                    </div>
                                    <div class="row ">
                                        <div class="col d-flex align-items-center justify-content-center text-center my-1">{{ $resource->description }}</div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-2 d-flex align-items-center justify-content-center">
                                    {{ date_format(date_create(Date($resource->created_at)), "F d, Y") }}
                                </div>
                                <div class="col-lg-2 col-md-3 d-flex align-items-center justify-content-center">
                                    <a href="{{ asset('storage/'.$resource->url) }}" class="btn text-gray-100 bg-green-800">Download <i class="fa fa-download"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
